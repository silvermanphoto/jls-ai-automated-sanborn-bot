...
Version 1.14 (2026-07-26) repaired the review-packet step, which had failed on every run since the batch engine shipped: it seeded the packet folder with the immutable control copy and then handed that same folder to a generator that refuses a folder holding anything. Nothing was ever drawn, so no sheet could reach approval or a final map. Real Tile 487 now exercises the whole chain — packet, approval, and final warp — producing 7713 × 6735 RGBA at scale ratio `1.0383` and axis angle `88.736°`, SHA-256 `537a7de47b63f98868c821b6bf868aa7c97246c99fdd0efc06d451dd009981e1`, identical across two independent runs, with the protected project unchanged.
